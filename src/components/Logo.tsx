...
export default function Logo({ compacto = false }: { compacto?: boolean }) {
  return (
    <Link href="/" className="flex items-center gap-3" aria-label="PetroLearn, ir al inicio">
      ...
      {!compacto && (
        <span className="leading-tight">
          <span className="block text-lg font-extrabold tracking-tight text-night">PetroLearn</span>
